...
<body>
    ...
    <main>
      <div id="wrapped">
        <h1 class="pmt">Request for withdrawal</h1>
        ...
        <div id="content-wrap">
          <form action="withdrawal-function.php" method="post">
          <div>
              <label>User ID</label>
            ...
            <div>
              <input type="submit" name="submit" id="request-pmt" value="Request payment">
            </div>
          </form>
