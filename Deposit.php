...
<body>
    ...
    <main>
      ...
      <div id="content-wrap">
        <form action="depositfunction.php" method="post">
          <label id="choose-plan">Choose a plan</label>
          <select name="plan" id="plan">
            <option selected value="1">Basic $5 - $30</option>
            <option value="2"> Platinum $30 - $70</option>
            <option value="3">Diamond $70 - $100</option>
          </select>
